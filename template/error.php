...
<head>
    ...
    <style>
        ...
        .box {
            ...
            padding: 1em 1em;
            text-align: center;
            background: url(<?php asset_img('flame.png') ?>) no-repeat top 10.5em center/128px 128px,
            transparent url(<?php asset_img('desktop.png') ?>) no-repeat top 13em center/128px 128px;
        }
