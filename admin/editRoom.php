...
<body>
    <section id="offer">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center p-4 mb-3 mt-4">Edytuj pokój: Turkusowy</h1>
                </div>
            </div>
        </div>
    </section>
      ...
      <div class="container">
          <div class="row">
              <div class="col-12 p-12">
                  ...
                  >
                      <div class="forms">
                          <p class="form-dark-label">Nazwa: <input type="text" name="name" id="room" placeholder="Nazwa" required value="Turkusowy"></p>
                          <p class="form-dark-label">Zdjęcie: <input type="file" name="photo" id="photo_room" required></p>
                          <p class="form-dark-label">Cena za dobę: <input type="number" name="price" id="price" required value="120"></p>
